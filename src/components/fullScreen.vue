<template>
    <div @click="fullScreen">
        <svg v-show="!isFull" t="1650977042854" viewBox="0 0 1024 1024" version="1.1" p-id="4082">
            <path
        ...
        <svg v-show="isFull" t="1650977224496" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="4236">
            <path
